# inventory-management GitOps Repository

This repository contains the GitOps deployment manifests for the inventory-management application container.

## Structure

```
inventory-management-gitops/
